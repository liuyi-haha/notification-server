    ...
    public void handle(MessageSentEvent event) {
        ...
        try {
            ...
            var messageType = switch (event.getMessageType()) {
                ...
                case SPEECH -> MessageType.MESSAGE_TYPE_AUDIO;
                case DOCUMENT -> MessageType.MESSAGE_TYPE_DOCUMENT;
            ...
            var notification = MessageReceivedNotification.newBuilder()
                    ...
                    .setTextContent(Objects.toString(event.getTextContent(), ""))
                    .setFileId(Objects.toString(event.getFileId(), ""))
